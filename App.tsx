          ...
          motion.div 
            ...
            main className=relative
              ...
              motion.section 
                ...
                div className=content-separatordiv
              ...
              motion.section 
                ...
                div className=max-w-7xl mx-auto text-center
                  ...
                  motion.div 
                    className=flex flex-col smflex-row gap-6 justify-center items-center max-w-2xl mx-auto
                    ...
                    motion.div
                      ...
                      Button 
                        ...
                        className=py-5 px-10 text-lg font-semibold text-white w-full smw-auto transition-all duration-300 shadow-lg hovershadow-xl uppercase tracking-wider min-h-[46px] lgmin-h-[50px]
                ...
                div className=max-w-7xl mx-auto text-center
                  ...
                  motion.div
                    ...
                    Button 
                      ...
                      className=py-5 px-10 text-lg font-semibold text-gray-800 transition-all duration-300 shadow-lg hovershadow-xl uppercase tracking-wider min-h-[46px] lgmin-h-[50px]
    ...
    div className=min-h-screen bg-white
      ...
      {isLoading && (
        motion.div
          ...
          animate={{ opacity 1 }}
          exit={{ opacity 0 }}
          className=fixed inset-0 bg-gradient-to-br from-blue-50010 to-orange-50010 backdrop-blur-sm z-50 flex items-center justify-center
